...
from ddd4py.common.notification import ConsumedNotification, PublishedNotificationTracker
...
if TYPE_CHECKING:
    ...
    from ddd4py.common.notification import ConsumedNotificationStore, PublishedNotificationTrackerStore
